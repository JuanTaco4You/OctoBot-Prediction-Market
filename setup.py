...
from octobot_prediction_market import PROJECT_NAME, AUTHOR, VERSION
...
setup(
    ...
    description='Crypto prediction market trading bot',
    py_modules=['start'],
    packages=PACKAGES,
    package_data={
        "": ["config/*"],
    ...
    entry_points={
        'console_scripts': [
            PROJECT_NAME.replace("-", "_") + ' = octobot_prediction_market.cli:main'
        ]
    },
    classifiers=[
